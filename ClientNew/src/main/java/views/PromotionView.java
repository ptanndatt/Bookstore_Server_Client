...
//Tảo bảng chọn sách
        ...
        chooserngayBatDau.setDate(new Date());
        chooserngayKetThuc.setToolTipText("Sau ngày bắt đầu");
        chooserngayKetThuc.setDate(new Date());
...
//                    ProductSale productSale= new ProductSale(product,promotion);
